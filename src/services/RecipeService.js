//const appId = "391aa893";
//const appKey = "0c6057e1ecc308f208994a40995f8a3a";
...
export default class RecipeService {
    ...
    static findRecipesByName(searchParam){
        let url = baseUrl + "api/recipe/" + searchParam;
        console.log(url);
        return fetch(url, {
            credentials: 'include'
        }).then(response => response.json())
            .catch(err => Promise.reject("Error in search"));

    }

    static updateRecipeById(recipeId,updatedRecipe){
        let url = baseUrl + "api/recipe/" + recipeId;
        return fetch(url,{
            method: 'PUT',
            headers:{
    ...
    .then(recipe => recipe.json())
            .catch(err => Promise.reject("Error in update"));
    }
    ...
    {
        //let url="https://api.yummly.com/v1/api/recipe/"+recipeId+"?_app_id=391aa893&_app_key=0c6057e1ecc308f208994a40995f8a3a"
